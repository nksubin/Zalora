...
//  AeroPlus
//
//  Created by Subin Kurian on 5/9/15.
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor =[UIColor colorWithRed:0.031f green:0.410f blue:0.725f alpha:1]; //[[UIColor blackColor] colorWithAlphaComponent:CSToastOpacity];
